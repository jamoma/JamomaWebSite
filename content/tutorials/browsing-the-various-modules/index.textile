...
Jamoma comes with a number of patchs (modules in the Jamoma terminology) ready to be used in the Max environment. They can be accessed thru the OS's file browser by going to the modules folder. A list of all available modules can be found on the "Index of modules":../modules/ page of this manual.
...
Please see jmod.layout help patch to see how it can help you to go thru all nice modules installed with Jamoma or read the "next tutorial":../create-new-module-in-a-patch/.

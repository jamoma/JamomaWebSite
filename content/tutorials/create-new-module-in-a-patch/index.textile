...
bq(note). Assuming you properly set up Max, note that you can create an object box containing your module by using the %(kbd)SHIFT% + %(kbd)m% key combo.
...
bq(note). Jamoma also have some shortcuts to ease the creation of modules as bpatchers. Use %(kbd)SHIFT;

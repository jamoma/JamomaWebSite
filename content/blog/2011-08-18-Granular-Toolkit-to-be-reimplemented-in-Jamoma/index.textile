---
layout: post
title: Granular Toolkit to be reimplemented in Jamoma
kind: article
created_at: 2011-08-18
location: Bergen, Norway
author: Trond Lossius
h1: Granular Toolkit to be reimplemented in Jamoma
categories:
- granulation
- granular tool kit
- gtk
...
"Nathan Wolek has just announced":http://www.lowkeydigitalstudio.com/2011/08/gtk-10-years/ that in order to ensure future usability as well as enable the code to be used in other hosting environments, he has decided to end development of GTK in its current form, and instead reimplement as new granular components in Jamoma.

...
p=. <%= fancyImage @item, "images/autocompletion.png", "images/autocompletion-thumb.png", "Autocompletion", "autocomplete" %>
...
p=. <%= fancyImage @item, "images/widget.png", "images/widget.png", "Widget assistance", "widget-assistance" %>
...
p=. <%= fancyImage @item, "images/tooltip.png", "images/tooltip-thumb.png", "Tooltip", "tooltip" %>
...
p=. <%= fancyImage @item, "images/documentation-attribute.png", "images/documentation-attribute-thumb.png", "@documentation attribute", "documentation-attribute" %>

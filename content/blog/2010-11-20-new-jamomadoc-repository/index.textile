...
If you just can not help by writing some documentation, be sure your feedbacks are still greatly appreciated. In addition to our regular "forum":http://jamoma.org/forum.html, we also set up a dedicated "tracker":http://redmine.jamoma.org/projects/documentation/issues where you can log some ideas, tutorial requests or just point out some typos which may have skipped from our attention.

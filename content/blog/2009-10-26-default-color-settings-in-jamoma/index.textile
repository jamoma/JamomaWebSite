...
p=. <%= fancyImage @item, "images/dark-module.png", "images/dark-module.png", "This is not the way Jamoma modules should look like", "wrong" %>
...
p=. p=. <%= fancyImage @item, "images/good-looking-module.png", "images/good-looking-module.png", "This is what Jamoma modules should look like", "wrong" %>

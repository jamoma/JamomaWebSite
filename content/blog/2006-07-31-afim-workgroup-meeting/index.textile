...
p=. <%= fancyImage @item, "images/diagram.png", "images/diagram.png", "Eve framework", "eve" %>
...
p=. <%= fancyImage @item, "images/matrix.png", "images/matrix.png", "Audio Matrix SeqCon", "matrix" %>

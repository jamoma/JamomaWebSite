...
This version requires OSX 10.7 or newer, as well as Max 6.0.8 or newer. Your download should start automatically. If you experience problems with the download, please try this "direct link":attachments/Jamoma-0.5.7.dmg.
...
If you also use TapTools, be sure to install "the latest (beta) version of TapTools 4":https://github.com/tap/TapTools/releases.

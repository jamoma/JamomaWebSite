...
Jamoma 0.6 is introducing major changes to how Jamoma Modules are structured, introducing true model-view-controller separation. 
...
Lz7tmLJthU. <br/><br/>This version requires OSX 10.7 or newer, as well as Max 6.1 or newer.

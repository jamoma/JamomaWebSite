...
# Press SHIFT+i to create "jmod.input~":/tutorials/modules/modules/jmod.input~.html
# Press SHIFT+o to create "jmod.output~":/tutorials/modules/modules/jmod.output~.html
...
If you want to know what files have been added via the Jamoma's Application Builder, let's take a look into our final _foo.app_.

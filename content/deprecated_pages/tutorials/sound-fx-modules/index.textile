...
* With the patch in edit mode, we can type <kbd>SHIFT + I</kbd> to create an input module. The module will show up at the position the mouse is pointing at when we type the shortcut.
* In the same way we can type <kbd>SHIFT + O</kbd> to create an output module.
...
* Shortcuts in Jamoma.
** Type <kbd>SHIFT + I</kbd> to create an input module.
** Type <kbd>SHIFT + O</kbd> to create an output module.
** Type <kbd>SHIFT + B</kbd> to create any module:

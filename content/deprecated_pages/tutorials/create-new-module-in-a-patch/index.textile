...
Modules can be created as "abstractions":http://www.cycling74.com/docs/max5/vignettes/core/abstractions.html, just like any regular Max patch saved to disk. In Max, open a blank patcher window and double-click in the window or press the <code>n</code> key to create a new object.


Once the object box is created, type in the name of the desired module. In this example, we will create a "jmod.degrade~":/tutorials/modules/jmod.degrade~/ module.

<%= fancyImage @item, "images/new_obj.png" %>
...
<%= fancyImage @item, "images/new_obj_2.png" %>

You may want to define a specific name to your module by typing an optional argument to the object box.

<%= fancyImage @item, "images/new_obj_3.png" %>

Assuming you properly set up Max, note that you can create an object box containing your module by using the <code>SHIFT + m</code> key combo.

<%= fancyImage @item, "images/new_obj_4.png" %>
...
<%= fancyImage @item, "images/new_bpatcher_1.png" %>
...
<%= fancyImage @item, "images/new_bpatcher_2.png" %>
...
<%= fancyImage @item, "images/new_bpatcher_3.png" %>
...
<%= fancyImage @item, "images/new_bpatcher_4.png" %>

My %(text-uppercase)mother% has %{color:blue}blue% eyes.

Jamoma also have some shortcuts to ease the creation of modules as bpatchers. Use <code>SHIFT + d</code> or <code>SHIFT + b</code> to create a bpatcher box with containers for module name and arguments.

h3. Using jmod.layout

Now that you know how to create an initial module, here is a special module which can come handy to build a whole patch. First, as explained previously, create a bpatcher containing Jamoma module named "jmod.layout":/tutorials/components/jmod.layout/ %(seq)1%. Once the module is initialized, click the top-right %(samp)EDIT% button %(seq)2%.

<%= fancyImage @item, "images/using_jcom.layout_1.png" %>
...
<%= fancyImage @item, "images/using_jcom.layout_2.png" %>
...
<%= fancyImage @item, "images/using_jcom.layout_3.png" %>
...
<%= fancyImage @item, "images/using_jcom.layout_4.png" %>

h3. Summary

- Modules can be created inside regular object boxes or as bpatchers
- Modules can be created using <code>SHIFT + m</code>, <code>SHIFT + d</code> or <code>SHIFT + b</code>
- "jmod.layout":/tutorials/components/jcom.layout/ can be useful to explore the growing list of modules and insert them in a patch

...
Modules can be created as "abstractions":http://www.cycling74.com/docs/max5/vignettes/core/abstractions.html, just like any regular Max patch saved to disk. In Max, open a blank patcher window and double-click in the window or press the <kbd>n</kbd> key to create a new object.
...
Assuming you properly set up Max, note that you can create an object box containing your module by using the <kbd>SHIFT + m</kbd> key combo.
...
Jamoma also have some shortcuts to ease the creation of modules as bpatchers. Use <kbd>SHIFT + d</kbd> or <kbd>SHIFT + b</kbd> to create a bpatcher box with containers for module name and arguments.
...
- Modules can be created using <kbd>SHIFT + m</kbd>, <kbd>SHIFT + d</kbd> or <kbd>SHIFT + b</kbd>

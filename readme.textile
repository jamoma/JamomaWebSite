...
In order to modify the website's content, you will need to edit (or add) pages in the content folder, by using the textile:http://en.wikipedia.org/wiki/Textile_(markup_language)format.
